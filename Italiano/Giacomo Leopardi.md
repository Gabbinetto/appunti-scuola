Leopardi nasce nel 1798 a **Recanati**, che lascia a 24 anni, per il quale svilupperà un'insofferenza più avanti nella vita. Viene da una famiglia agiata e di cultura tradizionale, infatti il padre aveva una biblioteca personale colma di classici, e aveva passato la passione classica a Leopardi, tanto che questi studiava i classici *in lingua originale* sin da piccolo. La madre invece era molto fredda e rigida. Leopardi ci parla, infatti, di un'educazione molto rigida.
...
Di questo passo rivaluta la natura. Questo perché la natura non è poi così benigna se ci crea destinati all'infelicità. Semplicemente la natura ha le sue regole, e noi umani le dobbiamo sopportare e seguire. Leopardi afferma che l'umanità ha superato questa tristezza grazie all'infelicità. L'infelicità è anche data dalla sua definizione dell'opposto, della felicità. Secondo Leopardi la felicità è data dal piacere, ma non da un piacere, bensì **il piacere**, ovvero un piacere infinito e irraggiungibile. Perciò in lui si crea una condizione di <i>insoddisfazione perpetua</i>.
...
Nei versi 100-157 dice che nobile non è colui che crede di meritare la felicità e che si riempe d'orgoglio, credendosi capace di grandi cose, mentre un semplice terremoto o soffio d'aria malata lascerebbe di lui solo il ricordo. Nobile è colui che è umile nei confronti del proprio posto nell'universo, che riconosce il male che ci viene assegnato nascendo e la condizione di miseria che ci spetta. Colui che sa che la natura è la vera colpevole e che crede l'umanità debba unirsi contro di essa, invece che farsi la guerra a vicenda, accusando gli altri delle proprie sventure e che giudica come stupido l'armarsi non contro la natura, ma contro i propri compagni. Solo quando saranno noti a tutti, com'erano una volta^[Presumibilmente nell'Impero Romano.], allora la società avrà basi solide e non si baserà su sentimenti di superbia e sull'errore.
Dopo continua terminando il giudizio verso gli intellettuali e descrive il paesaggio del Vesuvio, e ragiona^[Come nell'infinito.] su quanto il nostro mondo sia piccolo rispetto alle stelle, e di conseguenza quanto l'umanità sia infima rispetto alla vastità dell'universo. Addirittura definisce la Terra come uno "*scuro granello di sabbia*"^[Espressione usata poi da Pascoli.].
Continua poi con un lungo periodo che rievoca l'eruzione del Vesuvio nel 79, paragonandola alla caduta di un frutto che, in pochi istanti, uccide le formiche sottostanti, proprio per evidenziare quando nel complesso delle cose l'umanità sia infima e quanto la natura sia indifferente verso ogni forma di vita^[Proprio come afferma nel dialogo tra la Natura ed un Islandese.].
Poi riporta l'immagine di un contadino che vive coscientemente sul sul Vesuvio, che potrebbe lavare via tutto in pochi istanti, e tutto ciò che il contadino può fare è scappare con la famiglia e osservare il suo lavoro che viene distrutto. Alla natura tutto ciò non importa, ella procede il suo corso, ma luogo arrogantemente si vanta delle sue antiche epoche di "gloria".
Continua tornando a parlare alla ginestra, dicendo che anche questa prima o poi verrà spazzata via dalla lava, ma la ginestra sarà umile e si sottometterà al vulcano, senza supplicare pietà e senza opporsi con orgoglio, perché, saggiamente, la ginestra sa che la sua stirpe non è fatta per vivere in eterno, al centro dell'universo.
#### Struttura
- Versi 1-16: Parla alla ginestra
- Versi 17-37: Descrive la desolazione del Vesuvio.
- Versi 38-110: Critica la mentalità degli intellettuali del tempo
- Versi 111-157: Delinea la figura dell'uomo nobile
- Versi 158-201: Descrive liricamente i luoghi, proiettando la riflessione sull'infinito
- Versi 202-236: Torna a parlare dello stato di miseria della natura, dell'eruzione del 79 e della malignità della natura
- Versi 237-296: Descrive le rovine archeologiche di Pompei ed Ercolano, assieme all'immagine del contadino
- Versi 297-317: Parla di nuovo alla ginestra, definendo il comportamento umile alla quale l'uomo dovrebbe ispirarsi

## L'eredità di Leopardi nella letteratura
Il concetto di natura matrigna si ritrova in "***Spesso il male di vivere ho incontrato***" di **Montale**. Trova il dolore dell'esistere addirittura negli oggetti e nei suoni, come il gorgogliare dei ruscelli in piena, che paragona a versi strozzati di sofferenza. La natura maligna si trova soprattutto nell'espressione "**indifferenza divina**" perché entità superiore.
Altro parallelismo con Leopardi, specificamente con *l'Infinito*, è con l'opera, ancora una volta di Montale, "***Meriggiare pallido e assorto***". Anche qui chi scrive si trova isolato in un ambiente naturale, descrivendo le sensazioni sia visive che uditive, che poi continua con una tragica descrizione della vita come un travaglio^[Lavoro molto pesante], come un "muro con cocci aguzzi di bottiglia". Addirittura è più tragico di Leopardi, perché nell'Infinito ciò che c'è oltre il muro non si vede e quindi non lo si desidera. Qui, invece, ciò che c'è oltre lo si vede, lo si desidera, ma è irraggiungibile per colpa dei cocci.

Altro autore che si ispira a Leopardi è **Pascoli** nel "***X Agosto***", poesia che ricorda l'uccisione del padre avvenuta, appunto, il 10 agosto. Infatti inizia tragicamente con l'immagine del cielo che piange, ovvero le stelle cadenti di San Lorenzo^[Che cade proprio il 10 agosto], e continua con altre immagini tragiche come le rondini che cadono morenti. Continua nelle prossime due strofe descrivendo l'uccisione del padre. Nell'ultima strofa, come Leopardi che definisce la Terra un granello, definisce la Terra un "*atomo opaco del mare*".

Altra opera è "***Non gridate più***" di **Ungaretti**. Parla delle guerre mondiali e dice ai vivi di "non gridare" o altrimenti non si può udire *la voce dei morti*, ovvero si manca di rispetto alle loro memorie. Definisce la voce dei morti "sussurro impercettibile", più impercettibile "dell'erba che cresce"^[Che normalmente non fa davvero rumore], al quale dà il diritto di non essere calpestata, denotando una sensibilità leopardiana verso ogni essere vivente, contro l'antropocentrismo.
